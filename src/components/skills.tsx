  ...
  const skillsData = [
    ...
    },
    {
      ...
      skills: [
        ...
        'API Security Awareness (JWT, OAuth)',

        'LLM Concepts (ChatGPT, Whisper awareness)',
        'AI Agents',
        'Prompt engineering',
        'Vector databases (Weaviate, Pinecone)',
        'RAG (Retrieval-Augmented Generation)',
        'Tool routing & calling',
        'Research & Adaptability to New Technologies',
        'Version Control Workflow Mastery',
        'Data Processing (Python, Pandas Basics)',
        'API Security Awareness (JWT, OAuth)',
        'Next.js',
      ],
